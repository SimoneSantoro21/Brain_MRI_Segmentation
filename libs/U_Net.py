...
class UNet(nn.Module):
    ...
    def forward(self, x):
        ...
        b_neck = self.bottle_neck(pooled_4)

        upsampled_1 = self.up_convolution_1(b_neck, convolved_4)
        upsampled_2 = self.up_convolution_2(upsampled_1, convolved_3)
        upsampled_3 = self.up_convolution_3(upsampled_2, convolved_2)
